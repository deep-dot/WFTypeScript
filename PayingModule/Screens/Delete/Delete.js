      ...
      tx.executeSql(
        ...
        (_tx, results) => {
          ...
          if (len > 0) {
            ...
            setFlatListItems('');
              Alert.alert("Sorry!",
              "Record does not exist on this ID or Date"
              )
            }
        });
    });
      ...
      style = {{ backgroundColor: '#ffffff',
        ...
        >
         <View style={styles.textinputview}>
          ...
          <View style={styles.textinputview}>
          <Text style = {styles.titletext}>Manual docket value {'\n'} (For M31 or M30) </Text>
            <TextInput
              placeholder = '0.00'
              placeholderTextColor="#000000"
              style={styles.textInput}
            >
            <Text style = {styles.titletext}>{item.manual_lifting_fee_value}</Text>
            </TextInput>
          </View>
          ...
          <View style={styles.textinputview}>
            ...
            <TextInput
              ...
              style={styles.textInput}
            >
            <Text style = {styles.titletext}>{item.company_portion_lifting_fee}</Text>
            </TextInput>
          </View>
          ...
          <View style={styles.textinputview}>
            ...
            <TextInput
              ...
              style={styles.textInput}
            >
            <Text style = {styles.titletext}>{item.driver_portion_lifting_fee}</Text>
            </TextInput>
          </View>
          ...
          <View style={styles.textinputview}>
            <Text style={{ fontSize: 18, color:'#000000', fontWeight: 'bold' }}>Net Cash</Text>
            <TextInput
              placeholder = '0.00'
              placeholderTextColor="#000000"
              style={styles.textInput}
            >
           <Text style={{ fontSize: 18, color:'#000000', fontWeight: 'bold' }}>{item.Net_Payin}</Text>
            </TextInput>
          </View>
        </View>
    );
